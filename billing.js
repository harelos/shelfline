// Shelfline — Play Billing (Digital Goods API) + paywall. Generated. Loaded after the app.
(function(){'use strict';
const CFG={"key":"sf_ent","event":"shelfline-pro-changed","app":"Shelfline","accent":"#C96F4A","bg":"#F7F2E9","p1":"#FFFDF8","line":"#E7DFCD","ink":"#1E1B16","mut":"#8A8066","title":"Unlimited books, zero algorithm","sub":"The first 5 books a year are free. Keep reading past that with Pro — no social feed, no recommendations, just your own shelf.","benefits":["<b>Unlimited books</b> per year — free plan stops at 5","Yearly reading stats build automatically","Private by design — no social feed, no algorithm, no ads"],"plans":[{"key":"pro_yearly","name":"Annual","price":"$19.99","per":"/yr","tag":"Cancel anytime","hero":true},{"key":"pro_lifetime","name":"Lifetime","price":"$34.99","per":" once","tag":"Pay once, keep forever"}],"grants":{"pro_yearly":"pro","pro_lifetime":"pro"}};
